class PhotographerCard {
  ...
  createPhotographerCard() {
    ...
    const PhotographersCard = `
        <a href="photographer.html?id=${this._photographer.id}" class="portrait" aria-label="${this._photographer.name}" >
            <img src="${pathPortrait}" alt="${this._photographer.id}">
            <h2 aria-labelledby="photographers-name">${this._photographer.name}</h2>    
        </a>
        <p id="photographers-details">
